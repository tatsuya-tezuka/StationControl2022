...
class CEquipmentStatusView : public CFormView
{
	DECLARE_DYNCREATE(CEquipmentStatusView)

protected:
	CEquipmentStatusView();           // 動的生成で使用される protected コンストラクター
	virtual ~CEquipmentStatusView();

public:
	enum { IDD = IDD_DIALOG_EQSTATUS };
...
inline CStationControlDoc* CEquipmentStatusView::GetDocument() const
{
