...
IMPLEMENT_DYNCREATE(CTabScaptView34, CDialogEx)

CTabScaptView34::CTabScaptView34(CWnd* pParent /*=NULL*/)
: CDialogEx(CTabScaptView34::IDD, pParent)
{

}

CTabScaptView34::~CTabScaptView34()
{
}

void CTabScaptView34::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CTabScaptView34, CDialogEx)
	ON_BN_CLICKED(IDC_BUTTON_REJECT, &CTabScaptView34::OnBnClickedButtonReject)
	ON_BN_CLICKED(IDC_BUTTON_PLLBW, &CTabScaptView34::OnBnClickedButtonPllbw)
	ON_BN_CLICKED(IDC_BUTTON_AGCBW, &CTabScaptView34::OnBnClickedButtonAgcbw)
	ON_BN_CLICKED(IDC_BUTTON_BITRATE, &CTabScaptView34::OnBnClickedButtonBitrate)
	ON_BN_CLICKED(IDC_BUTTON_DCCTRL, &CTabScaptView34::OnBnClickedButtonDcctrl)
	ON_BN_CLICKED(IDC_BUTTON_RX, &CTabScaptView34::OnBnClickedButtonRx)
	ON_BN_CLICKED(IDC_BUTTON_DC, &CTabScaptView34::OnBnClickedButtonDc)
END_MESSAGE_MAP()


// CTabScaptView34 メッセージ ハンドラー

BOOL CTabScaptView34::OnInitDialog()
{
...
*/
/*============================================================================*/
void CTabScaptView34::OnBnClickedButtonReject()
{
...
*/
/*============================================================================*/
void CTabScaptView34::OnBnClickedButtonPllbw()
{
...
*/
/*============================================================================*/
void CTabScaptView34::OnBnClickedButtonAgcbw()
{
...
*/
/*============================================================================*/
void CTabScaptView34::OnBnClickedButtonBitrate()
{
...
*/
/*============================================================================*/
void CTabScaptView34::OnBnClickedButtonDcctrl()
{
...
*/
/*============================================================================*/
void CTabScaptView34::OnBnClickedButtonRx()
{
...
*/
/*============================================================================*/
void CTabScaptView34::OnBnClickedButtonDc()
{
...
*/
/*============================================================================*/
void CTabScaptView34::ControlParamExecute(UINT pos)
{
	CString mControlString = mScapt34Param[pos].nameS;
	CString str;
	GetDlgItem(mScapt34Param[pos].id)->GetWindowText(str);
	stControlValue val;
	val.ret = 0;
	val.type = mScapt34Param[pos].type;
	switch (val.type){
	case	eControlStatus:
...
*/
/*============================================================================*/
void CTabScaptView34::UpdateStatus()
{
	...
	int szControl = sizeof(mScapt34Param) / sizeof(mScapt34Param[0]);

	for (int i = 0; i < szControl; i++)
	{
		if (mScapt34Param[i].id == IDC_BUTTON_REJECT)
			continue;

		CString mControlString = mScapt34Param[i].nameK;
		CString str;
		GetDlgItem(mScapt34Param[i].id)->GetWindowText(str);
		stControlValue val;
		val.ret = 0;
		val.type = mScapt34Param[i].type;
		...
		if (mScapt34Param[i].id == IDC_STATIC_CARRVAL ||
			mScapt34Param[i].id == IDC_STATIC_CARRVAL2 ||
			mScapt34Param[i].id == IDC_MFCMASKEDEDIT_AGC ||
			mScapt34Param[i].id == IDC_MFCMASKEDEDIT_AGC2){
			((CColorStatic*)GetDlgItem(mScapt34Param[i].id))->SetText(str);
		}
		else{
			GetDlgItem(mScapt34Param[i].id)->SetWindowText(str);
		}
	}
	UpdateData(FALSE);
}
...
*/
/*============================================================================*/
void CTabScaptView34::InitStatus()
{
	int szControl = sizeof(mScapt34Param) / sizeof(mScapt34Param[0]);
...
*/
/*============================================================================*/
LRESULT CTabScaptView34::WindowProc(UINT message, WPARAM wParam, LPARAM lParam)
{
	switch (message){
