...
// CEquipmentStatusView34 ダイアログ

IMPLEMENT_DYNCREATE(CEquipmentStatusView34, CFormView)

CEquipmentStatusView34::CEquipmentStatusView34()
: CFormView(CEquipmentStatusView34::IDD)
{
...
void CEquipmentStatusView34::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CEquipmentStatusView34, CFormView)
END_MESSAGE_MAP()


// CEquipmentStatusView34 診断

#ifdef _DEBUG
void CEquipmentStatusView34::AssertValid() const
{
	CFormView::AssertValid();
}

#ifndef _WIN32_WCE
void CEquipmentStatusView34::Dump(CDumpContext& dc) const
{
	CFormView::Dump(dc);
}
#endif
CStationControlDoc* CEquipmentStatusView34::GetDocument() const // デバッグ以外のバージョンはインラインです。
{
...
// CEquipmentStatusView34 メッセージ ハンドラー


void CEquipmentStatusView34::OnInitialUpdate()
{
...
*/
/*============================================================================*/
void CEquipmentStatusView34::createTab()
{
	mControlList.clear();
	CRect rectTab;
	int pos = 0;
...
void CEquipmentStatusView34::createTab34()
{
	mControlList.clear();
	CRect rectTab;
	int pos = 0;
...
void CEquipmentStatusView34::createTab20()
{
	mControlList.clear();
	CRect rectTab;
	int pos = 0;
...
LRESULT CEquipmentStatusView34::WindowProc(UINT message, WPARAM wParam, LPARAM lParam)
{
	switch (message){
...
*/
/*============================================================================*/
bool CEquipmentStatusView34::Load(CArchive& ar)
{
	for (int i = 0; i < mSummaryGraphMax; i++){
		mSummary[i].Load(ar);
	}
...
*/
/*============================================================================*/
bool CEquipmentStatusView34::Save(CArchive& ar)
{
	for (int i = 0; i < mSummaryGraphMax; i++){
		mSummary[i].Save(ar);
	}
