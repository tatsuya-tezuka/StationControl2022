...
IMPLEMENT_DYNCREATE(CTabStrackView34, CDialogEx)

CTabStrackView34::CTabStrackView34(CWnd* pParent /*=NULL*/)
: CDialogEx(CTabStrackView34::IDD, pParent)
{

}

CTabStrackView34::~CTabStrackView34()
{
}

void CTabStrackView34::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CTabStrackView34, CDialogEx)
	ON_BN_CLICKED(IDC_BUTTON_REJECT, &CTabStrackView34::OnBnClickedButtonReject)
	ON_BN_CLICKED(IDC_BUTTON_PLLBW, &CTabStrackView34::OnBnClickedButtonPllbw)
	ON_BN_CLICKED(IDC_BUTTON_AGCBW, &CTabStrackView34::OnBnClickedButtonAgcbw)
	ON_BN_CLICKED(IDC_BUTTON_BITRATE, &CTabStrackView34::OnBnClickedButtonBitrate)
	ON_BN_CLICKED(IDC_BUTTON_DCCTRL, &CTabStrackView34::OnBnClickedButtonDcctrl)
	ON_BN_CLICKED(IDC_BUTTON_RX, &CTabStrackView34::OnBnClickedButtonRx)
	ON_BN_CLICKED(IDC_BUTTON_DC, &CTabStrackView34::OnBnClickedButtonDc)
END_MESSAGE_MAP()


// CTabStrackView34 メッセージ ハンドラー

BOOL CTabStrackView34::OnInitDialog()
{
...
*/
/*============================================================================*/
void CTabStrackView34::OnBnClickedButtonReject()
{
...
*/
/*============================================================================*/
void CTabStrackView34::OnBnClickedButtonPllbw()
{
...
*/
/*============================================================================*/
void CTabStrackView34::OnBnClickedButtonAgcbw()
{
...
*/
/*============================================================================*/
void CTabStrackView34::OnBnClickedButtonBitrate()
{
...
*/
/*============================================================================*/
void CTabStrackView34::OnBnClickedButtonDcctrl()
{
...
*/
/*============================================================================*/
void CTabStrackView34::OnBnClickedButtonRx()
{
...
*/
/*============================================================================*/
void CTabStrackView34::OnBnClickedButtonDc()
{
...
*/
/*============================================================================*/
void CTabStrackView34::ControlParamExecute(UINT pos)
{
	CString mControlString = mStrack34Param[pos].nameS;
	CString str;
	GetDlgItem(mStrack34Param[pos].id)->GetWindowText(str);
	stControlValue val;
	val.ret = 0;
	val.type = mStrack34Param[pos].type;
	switch (val.type){
	case	eControlStatus:
...
*/
/*============================================================================*/
void CTabStrackView34::UpdateStatus()
{
	...
	int szControl = sizeof(mStrack34Param) / sizeof(mStrack34Param[0]);

	for (int i = 0; i < szControl; i++)
	{
		if (mStrack34Param[i].id == IDC_BUTTON_REJECT)
			continue;

		CString mControlString = mStrack34Param[i].nameK;
		CString str;
		GetDlgItem(mStrack34Param[i].id)->GetWindowText(str);
		stControlValue val;
		val.ret = 0;
		val.type = mStrack34Param[i].type;
		...
		if (mStrack34Param[i].id == IDC_STATIC_CARRVAL ||
			mStrack34Param[i].id == IDC_STATIC_CARRVAL2 ||
			mStrack34Param[i].id == IDC_MFCMASKEDEDIT_AGC ||
			mStrack34Param[i].id == IDC_MFCMASKEDEDIT_AGC2){
			((CColorStatic*)GetDlgItem(mStrack34Param[i].id))->SetText(str);
		}
		else{
			GetDlgItem(mStrack34Param[i].id)->SetWindowText(str);
		}
	}
	UpdateData(FALSE);
}
...
*/
/*============================================================================*/
void CTabStrackView34::InitStatus()
{
	int szControl = sizeof(mStrack34Param) / sizeof(mStrack34Param[0]);
...
*/
/*============================================================================*/
LRESULT CTabStrackView34::WindowProc(UINT message, WPARAM wParam, LPARAM lParam)
{
	switch (message){
