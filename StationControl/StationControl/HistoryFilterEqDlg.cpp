...
BEGIN_MESSAGE_MAP(CHistoryFilterEqDlg, CBarChild)
	...
	ON_BN_CLICKED(IDC_CHECK_STATION1, &CHistoryFilterEqDlg::OnBnClickedCheckStation1)
	ON_BN_CLICKED(IDC_CHECK_STATION2, &CHistoryFilterEqDlg::OnBnClickedCheckStation2)
	ON_BN_CLICKED(IDC_CHECK_STATION3, &CHistoryFilterEqDlg::OnBnClickedCheckStation3)
	ON_BN_CLICKED(IDC_CHECK_STATION4, &CHistoryFilterEqDlg::OnBnClickedCheckStation4)
...
void CHistoryFilterEqDlg::OnBnClickedCheckStation1()
{
	UpdateData(TRUE);
	GetDlgItem(IDC_BUTTON_SENDER)->EnableWindow(m_bStation[0]);
//	theApp.m_pMainWnd->PostMessageW(WM_LBUTTONDOWN);
}
void CHistoryFilterEqDlg::OnBnClickedCheckStation2()
{
	UpdateData(TRUE);
	GetDlgItem(IDC_BUTTON_SENDER2)->EnableWindow(m_bStation[1]);
//	theApp.m_pMainWnd->PostMessageW(WM_LBUTTONDOWN);
}
void CHistoryFilterEqDlg::OnBnClickedCheckStation3()
{
	UpdateData(TRUE);
	GetDlgItem(IDC_BUTTON_SENDER3)->EnableWindow(m_bStation[2]);
//	theApp.m_pMainWnd->PostMessageW(WM_LBUTTONDOWN);
}
void CHistoryFilterEqDlg::OnBnClickedCheckStation4()
{
	UpdateData(TRUE);
