// EquipmentStatusView.cpp : 実装ファイル
//
...
// CEquipmentStatusView

IMPLEMENT_DYNCREATE(CEquipmentStatusView, CFormView)

CEquipmentStatusView::CEquipmentStatusView()
	: CFormView(CEquipmentStatusView::IDD)
{
...
void CEquipmentStatusView::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CEquipmentStatusView, CFormView)
END_MESSAGE_MAP()


// CEquipmentStatusView 診断

#ifdef _DEBUG
void CEquipmentStatusView::AssertValid() const
{
	CFormView::AssertValid();
}

#ifndef _WIN32_WCE
void CEquipmentStatusView::Dump(CDumpContext& dc) const
{
	CFormView::Dump(dc);
}
#endif
CStationControlDoc* CEquipmentStatusView::GetDocument() const // デバッグ以外のバージョンはインラインです。
{
...
// CEquipmentStatusView メッセージ ハンドラー


void CEquipmentStatusView::OnInitialUpdate()
{
...
*/
/*============================================================================*/
void CEquipmentStatusView::createTab()
{
	mControlList.clear();
	CRect rectTab;
	int pos = 0;
...
void CEquipmentStatusView::createTab34()
{
	mControlList.clear();
	CRect rectTab;
	int pos = 0;
...
void CEquipmentStatusView::createTab20()
{
	mControlList.clear();
	CRect rectTab;
	int pos = 0;
...
LRESULT CEquipmentStatusView::WindowProc(UINT message, WPARAM wParam, LPARAM lParam)
{
	switch (message){
...
*/
/*============================================================================*/
bool CEquipmentStatusView::Load(CArchive& ar)
{
	for (int i = 0; i < mSummaryGraphMax; i++){
		mSummary[i].Load(ar);
	}
...
*/
/*============================================================================*/
bool CEquipmentStatusView::Save(CArchive& ar)
{
	for (int i = 0; i < mSummaryGraphMax; i++){
		mSummary[i].Save(ar);
	}
