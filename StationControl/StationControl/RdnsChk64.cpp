...
#define CTRL_RNG_RX					_T("CTRL.RDYCHK_RNG RX@%s@%s,%s;")				// X/X(再生型)
...
#define CTRL_RNG_DR					_T("CTRL.RDYCHK_RNG DXR@%s@%s,%s;")				// X/X(TCR再生型)
...
#define MAC_INIT_DSNTCR_DEM		_T("INIT.DSNTCR-DEM")						// TLM X2帯
#define MAC_DSNTCR_DEM_FRM		_T("DSNTCR.TLM_FRAME_LENGTH")				// TLM X2帯　フレーム長
#define MAC_DSNTCR_DEM_LCK		_T("DSNTCR.SCH_TO_LCK")						// TLM X2帯　ロックオンカウント

#define MAC_INIT_SSTCRMOD		_T("INIT.SS-TCRMOD")						// CMD S帯
#define MAC_SSTCRMOD_FRM		_T("SS-TCRMOD.FRM_WORD_LEN")				// CMD S帯　フレーム長

#define MAC_INIT_DSNTCR_MOD		_T("INIT.DSNTCR-MOD")						// CMD X2帯
#define MAC_DSNTCR_MOD_FRM		_T("DSNTCR.SIM_FRAME_LENGTH")				// CMD X2帯　フレーム長
...
-# 局内ディレイ値計測 X/X-TCR（再生型） チェックボタン押下処理
...
-# テレメトリ伝送チェック S-TLMIN チェックボタン押下処理
...
-# テレメトリ伝送チェック X-TLMIN チェックボタン押下処理
...
-# テレメトリ伝送チェック X-TLMIN(2) チェックボタン押下処理
...
-# コマンド伝送チェック S-CMDOUT チェックボタン押下処理
...
-# コマンド伝送チェック X-CMDOUT チェックボタン押下処理
...
-# コマンド伝送チェック X-CMDOUT(2) チェックボタン押下処理
