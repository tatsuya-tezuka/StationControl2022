...
static const stControlParam mXhspd34Param[] = {
	...
	{ IDC_BUTTON_BITRATE,		_T("X-HRX.MOD_DATA_RATE_CONT"),		_T("BITRATE-XHRX"),					eControlDouble },
...
class CTabXhspdView34 : public CDialogEx
{
	DECLARE_DYNCREATE(CTabXhspdView34)

public:
	CTabXhspdView34(CWnd* pParent = NULL);   // 標準コンストラクター
	virtual ~CTabXhspdView34();

	// ダイアログ データ
	enum { IDD = IDD_TAB_XHSPD34 };
