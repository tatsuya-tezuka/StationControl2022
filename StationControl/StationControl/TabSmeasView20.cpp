...
// CTabSmeasView20 ダイアログ

IMPLEMENT_DYNCREATE(CTabSmeasView20, CDialogEx)

CTabSmeasView20::CTabSmeasView20(CWnd* pParent /*=NULL*/)
: CDialogEx(CTabSmeasView20::IDD, pParent)
{

}

CTabSmeasView20::~CTabSmeasView20()
{
}

void CTabSmeasView20::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CTabSmeasView20, CDialogEx)
END_MESSAGE_MAP()


// CTabSmeasView20 メッセージ ハンドラー


BOOL CTabSmeasView20::OnInitDialog()
{
...
*/
/*============================================================================*/
void CTabSmeasView20::UpdateStatus()
{
	CEngValCnv::obsname_t *obs_adr;	// 監視項目アドレス
	CSatelliteData& sd = theApp.GetSatelliteData();

	int szControl = sizeof(mSmeas20Param) / sizeof(mSmeas20Param[0]);
	for (int i = 0; i < szControl; i++)
	{
		CString mMonitorString = mSmeas20Param[i].nameK;
		CString str;
		stControlValue val;
		val.type = mSmeas20Param[i].type;
		...
		((CColorStatic*)GetDlgItem(mSmeas20Param[i].id))->SetText(str);
	}
	UpdateData(FALSE);
}
...
*/
/*============================================================================*/
void CTabSmeasView20::InitStatus()
{
	int szControl = sizeof(mSmeas20Param) / sizeof(mSmeas20Param[0]);
	for (int i = 0; i < szControl; i++)
	{
...
*/
/*============================================================================*/
LRESULT CTabSmeasView20::WindowProc(UINT message, WPARAM wParam, LPARAM lParam)
{
	switch (message){
