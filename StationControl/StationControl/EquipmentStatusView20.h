...
class CEquipmentStatusView20 : public CFormView
{
	DECLARE_DYNCREATE(CEquipmentStatusView20)

public:
	CEquipmentStatusView20();   // 標準コンストラクター
	virtual ~CEquipmentStatusView20();
...
inline CStationControlDoc* CEquipmentStatusView20::GetDocument() const
{
