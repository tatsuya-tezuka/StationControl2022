...
static const stControlParam mXrecvParam[] = {
	...
	{ IDC_BUTTON_BITRATE,		_T("DSNTCR.BIT_RATE_MON"),			_T("BITRATE-X2"),					eControlDouble },		// BIT RATE
...
class CTabXrecvView : public CDialogEx
{
	DECLARE_DYNCREATE(CTabXrecvView)

public:
	CTabXrecvView(CWnd* pParent = NULL);   // 標準コンストラクター
	virtual ~CTabXrecvView();
