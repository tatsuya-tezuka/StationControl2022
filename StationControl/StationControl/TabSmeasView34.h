...
static stControlParam mSmeas34Param[] = {
...
class CTabSmeasView34 : public CDialogEx
{
	DECLARE_DYNCREATE(CTabSmeasView34)

public:
	CTabSmeasView34(CWnd* pParent = NULL);   // 標準コンストラクター
	virtual ~CTabSmeasView34();
