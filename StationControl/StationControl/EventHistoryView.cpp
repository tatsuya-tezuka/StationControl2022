...
IMPLEMENT_DYNCREATE(CEventHistoryView, CHistroyView)

CEventHistoryView::CEventHistoryView()
{
	m_nHistoryType = eHistory_Event;
}
...
BEGIN_MESSAGE_MAP(CEventHistoryView, CHistroyView)
END_MESSAGE_MAP()


// CEventHistoryView 描画

void CEventHistoryView::OnDraw(CDC* pDC)
{
...
// CEventHistoryView 診断

#ifdef _DEBUG
void CEventHistoryView::AssertValid() const
{
	CHistroyView::AssertValid();
}

#ifndef _WIN32_WCE
void CEventHistoryView::Dump(CDumpContext& dc) const
{
...
// CEventHistoryView メッセージ ハンドラー

void CEventHistoryView::OnInitialUpdate()
{
...
*/
/*============================================================================*/
void CEventHistoryView::AddHistroy()
{
	CGraphMutex::Lock(eData);

	deque<stHistoryData>& data = theApp.GetDataCollection().GetEventHistoryData();
	while (!data.empty())
	{
...
*/
/*============================================================================*/
void CEventHistoryView::AddHistroy(stHistoryData& data, bool bDataAdd/*=true*/)
{
...
void CEventHistoryView::OnSize(UINT nType, int cx, int cy)
{
	CHistroyView::OnSize(nType, cx, cy);
}


LRESULT CEventHistoryView::WindowProc(UINT message, WPARAM wParam, LPARAM lParam)
{
	switch (message){
