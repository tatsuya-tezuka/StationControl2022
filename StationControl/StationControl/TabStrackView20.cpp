...
IMPLEMENT_DYNCREATE(CTabStrackView20, CDialogEx)

CTabStrackView20::CTabStrackView20(CWnd* pParent /*=NULL*/)
: CDialogEx(CTabStrackView20::IDD, pParent)
{

}

CTabStrackView20::~CTabStrackView20()
{
}

void CTabStrackView20::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CTabStrackView20, CDialogEx)
	ON_BN_CLICKED(IDC_BUTTON_REJECT, &CTabStrackView20::OnBnClickedButtonReject)
	ON_BN_CLICKED(IDC_BUTTON_PLLBW, &CTabStrackView20::OnBnClickedButtonPllbw)
	ON_BN_CLICKED(IDC_BUTTON_AGCBW, &CTabStrackView20::OnBnClickedButtonAgcbw)
	ON_BN_CLICKED(IDC_BUTTON_BITRATE, &CTabStrackView20::OnBnClickedButtonBitrate)
	ON_BN_CLICKED(IDC_BUTTON_DCCTRL, &CTabStrackView20::OnBnClickedButtonDcctrl)
	ON_BN_CLICKED(IDC_BUTTON_RX, &CTabStrackView20::OnBnClickedButtonRx)
	ON_BN_CLICKED(IDC_BUTTON_DC, &CTabStrackView20::OnBnClickedButtonDc)
END_MESSAGE_MAP()


// CTabStrackView20 メッセージ ハンドラー

BOOL CTabStrackView20::OnInitDialog()
{
...
*/
/*============================================================================*/
void CTabStrackView20::OnBnClickedButtonReject()
{
...
*/
/*============================================================================*/
void CTabStrackView20::OnBnClickedButtonPllbw()
{
...
*/
/*============================================================================*/
void CTabStrackView20::OnBnClickedButtonAgcbw()
{
...
*/
/*============================================================================*/
void CTabStrackView20::OnBnClickedButtonBitrate()
{
...
*/
/*============================================================================*/
void CTabStrackView20::OnBnClickedButtonDcctrl()
{
...
*/
/*============================================================================*/
void CTabStrackView20::OnBnClickedButtonRx()
{
...
*/
/*============================================================================*/
void CTabStrackView20::OnBnClickedButtonDc()
{
...
*/
/*============================================================================*/
void CTabStrackView20::ControlParamExecute(UINT pos)
{
	CString mControlString = mStrack20Param[pos].nameS;
	CString str;
	GetDlgItem(mStrack20Param[pos].id)->GetWindowText(str);

	if (mStrack20Param[pos].id == IDC_BUTTON_PLLBW)
	{
	...
	stControlValue val;
	val.ret = 0;
	val.type = mStrack20Param[pos].type;
	switch (val.type){
	case	eControlStatus:
...
*/
/*============================================================================*/
void CTabStrackView20::UpdateStatus()
{
	...
	int szControl = sizeof(mStrack20Param) / sizeof(mStrack20Param[0]);

	for (int i = 0; i < szControl; i++)
	{
		if (mStrack20Param[i].id == IDC_BUTTON_REJECT)
			continue;

		CString mControlString = mStrack20Param[i].nameK;
		CString str;
		GetDlgItem(mStrack20Param[i].id)->GetWindowText(str);
		stControlValue val;
		val.ret = 0;
		val.type = mStrack20Param[i].type;
		...
		if (mStrack20Param[i].id == IDC_STATIC_CARRVAL)
		{
		...
		if (mStrack20Param[i].id == IDC_STATIC_CARRVAL2)
		{
			if (str.CompareNoCase(_T("LOCK")) == 0 || str.CompareNoCase(_T("ON")) == 0)
			{
				mCarrVal2.SetBackColor(RGB(0, 255, 0), RGB(0, 255, 0));
		...
		if (mStrack20Param[i].id == IDC_STATIC_SUBCARRVAL)
		{
			if (str.CompareNoCase(_T("LOCK")) == 0 || str.CompareNoCase(_T("ON")) == 0)
			{
				mSubCarrVal.SetBackColor(RGB(0, 255, 0), RGB(0, 255, 0));
		...
		if (mStrack20Param[i].id == IDC_STATIC_VITERBIVAL)
		{
			if (str.CompareNoCase(_T("LOCK")) == 0 || str.CompareNoCase(_T("ON")) == 0)
			{
				mViterbiVal.SetBackColor(RGB(0, 255, 0), RGB(0, 255, 0));
		...
		if (mStrack20Param[i].id == IDC_STATIC_BITVAL)
		{
			if (str.CompareNoCase(_T("LOCK")) == 0 || str.CompareNoCase(_T("ON")) == 0)
			{
		...
		if (mStrack20Param[i].id == IDC_STATIC_FRAMEVAL)
		{
			if (str.CompareNoCase(_T("LOCK")) == 0 || str.CompareNoCase(_T("ON")) == 0)
			{
				mFrameVal.SetBackColor(RGB(0, 255, 0), RGB(0, 255, 0));
		...
		if (mStrack20Param[i].id == IDC_BUTTON_PLLBW)
		{
		...
		if (mStrack20Param[i].id == IDC_STATIC_CARRVAL ||
			mStrack20Param[i].id == IDC_STATIC_CARRVAL2 ||
			mStrack20Param[i].id == IDC_MFCMASKEDEDIT_AGC ||
			mStrack20Param[i].id == IDC_MFCMASKEDEDIT_AGC2){
			((CColorStatic*)GetDlgItem(mStrack20Param[i].id))->SetText(str);
		}
		else{
			GetDlgItem(mStrack20Param[i].id)->SetWindowText(str);
		}
	}
	UpdateData(FALSE);
}
...
*/
/*============================================================================*/
void CTabStrackView20::InitStatus()
{
	int szControl = sizeof(mStrack20Param) / sizeof(mStrack20Param[0]);
...
*/
/*============================================================================*/
LRESULT CTabStrackView20::WindowProc(UINT message, WPARAM wParam, LPARAM lParam)
{
	switch (message){
