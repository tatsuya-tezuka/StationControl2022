...
// CTabSrecvView20 ダイアログ

IMPLEMENT_DYNCREATE(CTabSrecvView20, CDialogEx)

CTabSrecvView20::CTabSrecvView20(CWnd* pParent /*=NULL*/)
: CDialogEx(CTabSrecvView20::IDD, pParent)
{

}

CTabSrecvView20::~CTabSrecvView20()
{
}

void CTabSrecvView20::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CTabSrecvView20, CDialogEx)
	ON_BN_CLICKED(IDC_BUTTON_REJECT, &CTabSrecvView20::OnBnClickedButtonReject)
	ON_BN_CLICKED(IDC_BUTTON_PLLBW, &CTabSrecvView20::OnBnClickedButtonPllbw)
	ON_BN_CLICKED(IDC_BUTTON_AGCBW, &CTabSrecvView20::OnBnClickedButtonAgcbw)
	ON_BN_CLICKED(IDC_BUTTON_BITRATE, &CTabSrecvView20::OnBnClickedButtonBitrate)
	ON_BN_CLICKED(IDC_BUTTON_DCCTRL, &CTabSrecvView20::OnBnClickedButtonDcctrl)
	ON_BN_CLICKED(IDC_BUTTON_RX, &CTabSrecvView20::OnBnClickedButtonRx)
	ON_BN_CLICKED(IDC_BUTTON_DC, &CTabSrecvView20::OnBnClickedButtonDc)
END_MESSAGE_MAP()


// CTabSrecvView20 メッセージ ハンドラー

BOOL CTabSrecvView20::OnInitDialog()
{
...
*/
/*============================================================================*/
void CTabSrecvView20::OnBnClickedButtonReject()
{
...
*/
/*============================================================================*/
void CTabSrecvView20::OnBnClickedButtonPllbw()
{
...
*/
/*============================================================================*/
void CTabSrecvView20::OnBnClickedButtonAgcbw()
{
...
*/
/*============================================================================*/
void CTabSrecvView20::OnBnClickedButtonBitrate()
{
...
*/
/*============================================================================*/
void CTabSrecvView20::OnBnClickedButtonDcctrl()
{
...
*/
/*============================================================================*/
void CTabSrecvView20::OnBnClickedButtonRx()
{
...
*/
/*============================================================================*/
void CTabSrecvView20::OnBnClickedButtonDc()
{
...
*/
/*============================================================================*/
void CTabSrecvView20::ControlParamExecute(UINT pos)
{
	CString mControlString = mSrecv20Param[pos].nameS;
	CString str;
	GetDlgItem(mSrecv20Param[pos].id)->GetWindowText(str);
	stControlValue val;
	val.ret = 0;
	val.type = mSrecv20Param[pos].type;
	switch (val.type){
	case	eControlStatus:
...
*/
/*============================================================================*/
void CTabSrecvView20::UpdateStatus()
{
	...
	int szControl = sizeof(mSrecv20Param) / sizeof(mSrecv20Param[0]);

	for (int i = 0; i < szControl; i++)
	{
		if (mSrecv20Param[i].id == IDC_BUTTON_REJECT)
			continue;

		CString mControlString = mSrecv20Param[i].nameK;
		CString str;
		GetDlgItem(mSrecv20Param[i].id)->GetWindowText(str);
		stControlValue val;
		val.ret = 0;
		val.type = mSrecv20Param[i].type;
		...
		if (mSrecv20Param[i].id == IDC_STATIC_CARRVAL)
		{
		...
		if (mSrecv20Param[i].id == IDC_STATIC_CARRVAL2)
		{
			if (str.CompareNoCase(_T("LOCK")) == 0 || str.CompareNoCase(_T("ON")) == 0)
			{
				mCarrVal2.SetBackColor(RGB(0, 255, 0), RGB(0, 255, 0));
		...
		if (mSrecv20Param[i].id == IDC_STATIC_SUBCARRVAL)
		{
			if (str.CompareNoCase(_T("LOCK")) == 0 || str.CompareNoCase(_T("ON")) == 0)
			{
				mSubCarrVal.SetBackColor(RGB(0, 255, 0), RGB(0, 255, 0));
		...
		if (mSrecv20Param[i].id == IDC_STATIC_VITERBIVAL)
		{
			if (str.CompareNoCase(_T("LOCK")) == 0 || str.CompareNoCase(_T("ON")) == 0)
			{
				mViterbiVal.SetBackColor(RGB(0, 255, 0), RGB(0, 255, 0));
		...
		if (mSrecv20Param[i].id == IDC_STATIC_BITVAL)
		{
			if (str.CompareNoCase(_T("LOCK")) == 0 || str.CompareNoCase(_T("ON")) == 0)
			{
		...
		if (mSrecv20Param[i].id == IDC_STATIC_FRAMEVAL)
		{
			if (str.CompareNoCase(_T("LOCK")) == 0 || str.CompareNoCase(_T("ON")) == 0)
			{
				mFrameVal.SetBackColor(RGB(0, 255, 0), RGB(0, 255, 0));
		...
		if (mSrecv20Param[i].id == IDC_STATIC_CARRVAL ||
			mSrecv20Param[i].id == IDC_STATIC_CARRVAL2 ||
			mSrecv20Param[i].id == IDC_STATIC_SUBCARRVAL ||
			mSrecv20Param[i].id == IDC_STATIC_VITERBIVAL ||
			mSrecv20Param[i].id == IDC_STATIC_BITVAL ||
			mSrecv20Param[i].id == IDC_STATIC_FRAMEVAL ||
			mSrecv20Param[i].id == IDC_MFCMASKEDEDIT_AGC ||
			mSrecv20Param[i].id == IDC_MFCMASKEDEDIT_AGC2){
			((CColorStatic*)GetDlgItem(mSrecv20Param[i].id))->SetText(str);
		}
		else
			GetDlgItem(mSrecv20Param[i].id)->SetWindowText(str);
	}
	UpdateData(FALSE);
}
...
*/
/*============================================================================*/
void CTabSrecvView20::InitStatus()
{
	int szControl = sizeof(mSrecv20Param) / sizeof(mSrecv20Param[0]);
...
*/
/*============================================================================*/
LRESULT CTabSrecvView20::WindowProc(UINT message, WPARAM wParam, LPARAM lParam)
{
	switch (message){
