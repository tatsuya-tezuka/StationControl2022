...
IMPLEMENT_DYNCREATE(CTabXtrackView34, CDialogEx)

CTabXtrackView34::CTabXtrackView34(CWnd* pParent /*=NULL*/)
: CDialogEx(CTabXtrackView34::IDD, pParent)
{

}

CTabXtrackView34::~CTabXtrackView34()
{
}

void CTabXtrackView34::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CTabXtrackView34, CDialogEx)
	ON_BN_CLICKED(IDC_BUTTON_REJECT, &CTabXtrackView34::OnBnClickedButtonReject)
	ON_BN_CLICKED(IDC_BUTTON_PLLBW, &CTabXtrackView34::OnBnClickedButtonPllbw)
	ON_BN_CLICKED(IDC_BUTTON_AGCBW, &CTabXtrackView34::OnBnClickedButtonAgcbw)
	ON_BN_CLICKED(IDC_BUTTON_BITRATE, &CTabXtrackView34::OnBnClickedButtonBitrate)
	ON_BN_CLICKED(IDC_BUTTON_DCCTRL, &CTabXtrackView34::OnBnClickedButtonDcctrl)
	ON_BN_CLICKED(IDC_BUTTON_RX, &CTabXtrackView34::OnBnClickedButtonRx)
	ON_BN_CLICKED(IDC_BUTTON_DC, &CTabXtrackView34::OnBnClickedButtonDc)
END_MESSAGE_MAP()


// CTabXtrackView34 メッセージ ハンドラー

BOOL CTabXtrackView34::OnInitDialog()
{
...
*/
/*============================================================================*/
void CTabXtrackView34::OnBnClickedButtonReject()
{
...
*/
/*============================================================================*/
void CTabXtrackView34::OnBnClickedButtonPllbw()
{
...
*/
/*============================================================================*/
void CTabXtrackView34::OnBnClickedButtonAgcbw()
{
...
*/
/*============================================================================*/
void CTabXtrackView34::OnBnClickedButtonBitrate()
{
...
*/
/*============================================================================*/
void CTabXtrackView34::OnBnClickedButtonDcctrl()
{
...
*/
/*============================================================================*/
void CTabXtrackView34::OnBnClickedButtonRx()
{
...
*/
/*============================================================================*/
void CTabXtrackView34::OnBnClickedButtonDc()
{
...
*/
/*============================================================================*/
void CTabXtrackView34::ControlParamExecute(UINT pos)
{
	CString mControlString = mXtrack34Param[pos].nameS;
	CString str;
	GetDlgItem(mXtrack34Param[pos].id)->GetWindowText(str);
	stControlValue val;
	val.ret = 0;
	val.type = mXtrack34Param[pos].type;
	switch (val.type){
	case	eControlStatus:
...
*/
/*============================================================================*/
void CTabXtrackView34::UpdateStatus()
{
	...
	int szControl = sizeof(mXtrack34Param) / sizeof(mXtrack34Param[0]);

	for (int i = 0; i < szControl; i++)
	{
		if (mXtrack34Param[i].id == IDC_BUTTON_REJECT)
			continue;

		CString mControlString = mXtrack34Param[i].nameK;
		CString str;
		GetDlgItem(mXtrack34Param[i].id)->GetWindowText(str);
		stControlValue val;
		val.ret = 0;
		val.type = mXtrack34Param[i].type;
		...
		if (mXtrack34Param[i].id == IDC_STATIC_CARRVAL ||
			mXtrack34Param[i].id == IDC_STATIC_CARRVAL2 ||
			mXtrack34Param[i].id == IDC_MFCMASKEDEDIT_AGC ||
			mXtrack34Param[i].id == IDC_MFCMASKEDEDIT_AGC2)
			((CColorStatic*)GetDlgItem(mXtrack34Param[i].id))->SetText(str);
		else
			GetDlgItem(mXtrack34Param[i].id)->SetWindowText(str);
	}
	UpdateData(FALSE);
}
...
*/
/*============================================================================*/
void CTabXtrackView34::InitStatus()
{
	int szControl = sizeof(mXtrack34Param) / sizeof(mXtrack34Param[0]);
...
*/
/*============================================================================*/
LRESULT CTabXtrackView34::WindowProc(UINT message, WPARAM wParam, LPARAM lParam)
{
	switch (message){
