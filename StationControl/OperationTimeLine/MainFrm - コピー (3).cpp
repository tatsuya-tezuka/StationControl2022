...
#else
	CString strOpenMsg;
	strOpenMsg.Format(_T("open %sStatusError.wav type waveaudio alias serror"), theApp.GetAppPath());
	//int err = mciSendString(_T("open StatusError.wav type waveaudio alias serror"), NULL, 0, NULL);
