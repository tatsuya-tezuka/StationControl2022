================================================================================
    MFC (MICROSOFT FOUNDATION CLASS) ライブラリ : FAPanelBrowser プロジェクトの概要
===============================================================================

この FAPanelBrowser アプリケーションは、アプリケーション ウィザードによって作成されました。このアプリケーションは MFC の基本的な使い方を示すだけでなく、アプリケーションを作成するための開始点でもあります。

このファイルには、FAPanelBrowser アプリケーションを構成する各ファイルの内容の概要が含まれています。

FAPanelBrowser.vcxproj
...
FAPanelBrowser.vcxproj.filters
...
FAPanelBrowser.h
    ...
    その他のプロジェクト固有のヘッダー (Resource.h など) が含まれ、CFAPanelBrowserApp アプリケーション クラスを宣言します。

FAPanelBrowser.cpp
    これはメインのアプリケーション ソース ファイルで、CFAPanelBrowserApp アプリケーション クラスが含まれています。
...
res\FAPanelBrowser.ico
    これはアプリケーションのアイコンとして使用されるアイコン ファイルです。このアイコンは、メイン リソース ファイル FAPanelBrowser.rc にインクルードされます。

res\FAPanelBrowser.rc2
...
FAPanelBrowserDoc.h, FAPanelBrowserDoc.cpp - ドキュメント
    これらのファイルには、CFAPanelBrowserDoc クラスが含まれます。これらのファイルを編集して、特殊なドキュメント データを追加し、ファイルの保存と読み込みを実装することができます (CFAPanelBrowserDoc::Serialize を使用)。

FAPanelBrowserView.h, FAPanelBrowserView.cpp - ドキュメントのビュー
    これらのファイルには、CFAPanelBrowserView クラスが含まれます。
    CFAPanelBrowserView オブジェクトは CFAPanelBrowserDoc オブジェクトを表示するために使用されます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルは、FAPanelBrowser.pch という名前のプリコンパイル済みヘッダー (PCH) ファイルと、StdAfx.obj という名前のプリコンパイル済みの型ファイルをビルドするために使用されます。

Resource.h
    これは、新しいリソース ID を定義する標準のヘッダー ファイルです。このファイルの読み込みおよび更新は、Microsoft Visual C++ で行います。

FAPanelBrowser.manifest
