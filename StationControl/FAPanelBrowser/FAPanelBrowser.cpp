...
// FAPanelBrowser.cpp : アプリケーションのクラス動作を定義します。
//
...
// 唯一の CFAPanelBrowserApp オブジェクトです。

CFAPanelBrowserApp theApp;


// CFAPanelBrowserApp 初期化
...
// CFAPanelBrowserApp メッセージ ハンドラー
